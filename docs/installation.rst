...
The sources for xhydro-lstm can be downloaded from the `Github repo <https://github.com/hydrologie/xhydro-lstm>`_.
...
Or download the `tarball <https://github.com/hydrologie/xhydro-lstm/tarball/main>`_:
