#!/usr/bin/env python
#
# xhydro_lstm documentation build configuration file, created by
...
version = xhydro_lstm.__version__
# The full version, including alpha/beta/rc tags.
release = xhydro_lstm.__version__
...
htmlhelp_basename = 'xhydro_lstmdoc'
...
latex_documents = [
    (master_doc, 'xhydro_lstm.tex',
     'xhydro-lstm Documentation',
     'Richard Arsenault', 'manual'),
]
