...
clean-docs: ## remove docs artifacts
	rm -f docs/apidoc/xhydro_lstm*.rst
...
lint: install-lint ## check style
	...
	python -m vulture src/xhydro_lstm tests
	codespell src/xhydro_lstm tests docs
	python -m deptry src
	python -m yamllint --config-file=.yamllint.yaml src/xhydro_lstm
